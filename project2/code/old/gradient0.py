...
def stochastic(p=False):
    ...
    X = tools.PolyDesignMatrix(input.T, d=d)
    ...
    filename = "output/data/SGDLOG_{:}_{:}_{:}_{:}_{:}_.csv".format(d, ep, bs, lr_s, gm_s)
    filename2 = "output/data/SGDLOG_{:}_{:}_{:}_{:}_{:}_.txt".format(d, ep, bs, lr_s, gm_s)
